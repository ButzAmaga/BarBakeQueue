...
class RatingDispatchView(View):
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            rating = Rating.objects.get(cake=cake, user=customer.objects.get(account = request.user))  # per-user logic
            return RatingUpdateView.as_view()(request, pk=rating.pk, **kwargs)
